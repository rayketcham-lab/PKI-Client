...
<!-- Project Info -->
[![Version](https://img.shields.io/badge/version-0.6.1-blue?logo=semver&logoColor=white)](https://github.com/rayketcham-lab/PKI-Client/releases)
...
```bash
curl -fsSL https://raw.githubusercontent.com/rayketcham-lab/PKI-Client/main/install.sh | sudo bash -s -- v0.6.1
```
...
```bash
curl -fSL -o pki.tar.gz https://github.com/rayketcham-lab/PKI-Client/releases/latest/download/pki-v0.6.1-x86_64-linux.tar.gz
tar xzf pki.tar.gz
...
```bash
gh attestation verify pki-v0.6.1-x86_64-linux.tar.gz --repo rayketcham-lab/PKI-Client
```

**Cosign signature (Sigstore):**
```bash
curl -fSL -o pki.tar.gz.bundle https://github.com/rayketcham-lab/PKI-Client/releases/latest/download/pki-v0.6.1-x86_64-linux.tar.gz.bundle
cosign verify-blob \
  --bundle pki-v0.6.1-x86_64-linux.tar.gz.bundle \
  --certificate-oidc-issuer https://token.actions.githubusercontent.com \
  --certificate-identity-regexp "github.com/rayketcham-lab/PKI-Client" \
  pki-v0.6.1-x86_64-linux.tar.gz
```

...
def build_act2() -> None:
    ...
    banner_lines = [
        ...
        f"   {c('0;36')}╚══════════════════════════════════════════════════════╝{RESET}",
        "",
        "   Last login: Mon Mar 24 01:19:23 2026 from 192.168.1.170",
        "",
    ]
...
def build_act4() -> None:
    ...
    emit_at(ts, PKI_PROMPT)
    ts = round(ts + 0.2, 4)
    ts = type_string("show /etc/pki/certs/james.r.ketcham.pem", ts)
    ts = round(ts + 0.1, 4)
    emit_at(ts, "\r\n")
    ...
    cert_lines = [
        ...
        f"    Subject:        {BOLD_WHITE}James R Ketcham + uid=E21127560{RESET}",
        f"    Issuer:         {YELLOW}DC=com, DC=rtx, O=CAs, OU=Class3-G3, CN=Raytheon Technologies Medium Assurance CA{RESET} {CYAN}(Raytheon/RTX){RESET}",
        ...
        f"        Issuer: DC=com, DC=rtx, O=CAs, OU=Class3-G3, CN=Raytheon Technologies Medium Assurance CA",
        f"        Validity:",
        f"            Not Before: Feb 11 18:22:58 2026 UTC",
        f"            Not After : Feb 10 18:52:16 2029 UTC {CYAN}1054 days{RESET}",
        f"            Lifetime : [{BOLD_GREEN}█{RESET}░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░] 3.7%",
        f"        Subject: DC=com, DC=rtx, O=CAs, OU=Class3-G3, OU=Users, CN=James R Ketcham + uid=E21127560",
        ...
        f"                email:james.r.ketcham@rtx.com",
        ...
        f"                OCSP (1.3.6.1.5.5.7.48.1) - URI:{CYAN}http://pki.rtx.com/ocsp/{RESET}",
        f"                CA Issuers (1.3.6.1.5.5.7.48.2) - URI:{CYAN}http://pki.rtx.com/G3/aia/Class3-G3_01.p7c{RESET}",
        f"            X509v3 CRL Distribution Points (2.5.29.31):",
        f"                URI:{CYAN}http://pki.rtx.com/G3/CRLs/Class3-G3_Full.crl{RESET}",
        f"            X509v3 Certificate Policies (2.5.29.32):",
        f"                Policy: 1.3.6.1.4.1.26769.10.1.13",
        f"    Signature Algorithm: sha256WithRSAEncryption",
        "",
        f"Fingerprints:",
        f"    SHA-256:        4863eeb183a17520bf7c1938bbfa681e8ca38296910148bb8a37d94e9d3eff1f",
        f"    SHA-1:          1a0b7bc0ad43672f7dd7bada5790ca4f92f368ee",
        f"    SPKI Pin:       A4ZCVO800391Xqi3I4nx+IrIkNkuB79ZFVPdPw4meTE=",
        "",
        "",
        f"Certificate Chain:",
        "",
        ...
        f"            │                                                       │",
        f"            └─► Raytheon Technologies Medium Assurance CA            └─► Raytheon Technologies Medium Assurance CA",
        f"                {DIM}(inferred){RESET}                                              {CYAN}129 days{RESET} | RSA 3072",
        f"                │                                                       │",
        f"                └─► James R Ketcham + uid=E21127560                     └─► James R Ketcham + uid=E21127560 {BOLD_CYAN}← this cert{RESET}",
...
def build_act7() -> None:
    ...
    pqc_lines = [
        ...
        f"    Signature Algorithm: {BOLD_MAGENTA}ML-DSA-87{RESET}",
        "",
        f"Fingerprints:",
        f"    SHA-256:        8cfb5471c088603d2501a635972bb894e01aac19c938add4d45d56c5c89490b4",
        f"    SHA-1:          d3e0d4451f10eecca0b04f6a1704412f984e1001",
        f"    SPKI Pin:       Fe+nPJGxYv66cZbouBe3xUABkG9Se0L2MuDuU+/yzy0=",
        "",
        f"Certificate Chain:",
        "",
